  ...
  return (
    <>
      <ConfigProvider theme={{ algorithm: theme.darkAlgorithm }}>
        ...
        <p>
          Drop a .wav file to normalize it to -14 dB LUFS Integrated loudness and -1 dB TruePeak.
        </p>
        <p>All processing is done in your browser. Nothing is uploaded. May contain nuts.</p>
